...
const faqData = [
  {
    ...
    answer:
      "Cryptocurrency exchanges are digital marketplaces that enable users to buy and sell cryptocurrencies like Bitcoin, Ethereum, and Tether. TheWorldEx exchange is the largest crypto exchange by trade volume.",
  },
  {
    id: 2,
    question: "What products does WorldEx provide?",
    answer:
      "CryptCurr provides products like spot trading, futures, staking, savings, and its own BNB token for discounted fees.",
  },
  {
    id: 3,
    question: "How to buy Bitcoin and other cryptocurrencies on WorldEx",
    answer:
      "You can buy cryptocurrencies using credit/debit cards, bank transfers, or peer-to-peer (P2P) trading onWorldEx.",
  },
  {
    id: 4,
  ...
  {
    id: 5,
    question: "How to trade cryptocurrencies on WorldEx",
    answer:
      "To trade, register onWorldEx, deposit funds, and use the spot or futures market to place buy/sell orders.",
  },
  {
    id: 6,
    question: "How to earn from crypto on WorldEx",
    answer:
      "You can earn by staking, providing liquidity, participating in launchpools, and usingWorldEx Earn programs.",
  },
];
const Faq = () => {
